...
var string = new Array("art.phoenix.welcome",
					   "art.phoenix.logoff",
...
do_message_reader = true;
	...
	//if disabled... enter your desired string here...
	var messageReader = "\1nrÞÞÝh±Þnþ rhkeadingn y<<hw@SMB_CURMSG@\1yof\1n\1h\1w@SMB_MSGS@y>>kw ::y <n?-hhkelpny>hk y;n";
	...
	bbs.replace_text(33,"\r\n\1nrÞÞÝh±Þnþ shkaving..."); //saving statement...
	bbs.replace_text(34,"\r\n\1nrÞÞÝh±Þnþ shkaved \1n%lun characters (n%un lines)...n"); //saved statement...
	bbs.replace_text(35,"\r\n\1nrÞÞÝh±Þnþ whkriting index..."); //writing index statement...
	bbs.replace_text(37,"\r\n\1nrÞÞÝh±Þnþ phkosted on \1n%s %s\r\n"); //posted on statement...
	bbs.replace_text(11,"\r\n\1nrÞÞÝh±Þnþ phkost on \1n%s %s"); //post on question...
	bbs.replace_text(19,"\r\n\1nrÞÞÝh±Þnþ phkosting on \1n%s %s"); //posting on statement...
	bbs.replace_text(597,"\r\n\r\n\1nrÞÞÝh±Þnþ phkost to: "); //post to...
	bbs.replace_text(21,"\r\n\1nrÞÞÝh±Þnþ shkubject...\r\n\1nrÞÞÝh±Þnþ "); //subject...
	bbs.replace_text(30,"\r\n\1nrÞÞÝh±Þnþ ahkborted...\r\n\1n\1k"); //aborted...
	bbs.replace_text(56,"\r\n\1nrÞÞÝh±Þnþ fhkorward mail to\1n\1h\1y: ");	//forward mail to...

	//string changes for the help menu and additional commands...
	bbs.replace_text(48,"\r\n\1nrÞÞÝh±Þnþ shn\1k\1htart with number \1n\1y\1h<<w%lu\1ny>> \1n\1y\1h; w"); //start with # string...
	bbs.replace_text(76,"\r\n\1nrÞÞÝh±Þnþ s\1n\1h\1ktring to search for \1n\1y\1h; \1h\1w"); //string to search for...
	bbs.replace_text(625,"\r\n\1nrÞÞÝh±Þnþ d\1n\1k\1hisplay subjects only "); //display subjects only question... 
	bbs.replace_text(70,"\r\n\1nrÞÞÝh±Þnþ \1np\1n\1h\1kost \1n\1h\1w:: \1n\1y<<\1n\1h\1w%un\1y\1h>> <<h\1n\1w\1h%un\1y>> h\1w%lun/h\1w%lu\r\n"); //continuous read prompt...
	bbs.replace_text(620,"\r\n\1nrÞÞÝh±Þnþ \1nr\1n\1h\1kemove sub from newscan list"); //bypass subboard from newscan question....
	bbs.replace_text(10,"\r\n\1nrÞÞÝh±Þnþ \1ne\1n\1h\1kmail username or number \1n\1h\1y; \1n"); //reply via email option... 
	bbs.replace_text(432,"\r\n\1nrÞÞÝh±Þnþ \1nn\1h\1ketmail  \1n\1h\1y; \1nh%s\r\n");  //netmail info...   
	bbs.replace_text(499,"\r\n\1nrÞÞÝh±Þnþ \1nf\1n\1h\1korward to netmail account"); //forward mail question...
	bbs.replace_text(62,"\r\n\1nrÞÞÝh±Þnþ \1ns\1n\1h\1kending netmail to \1n%s\r\n\1nrÞÞÝh±Þnþ \1nf\1h\1krom \1n%s\r\n"); //sending netmail info... 
	bbs.replace_text(18,"\r\n\1nrÞÞÝh±Þnþ \1ns\1n\1h\1kending email to \1n%s\r\n"); //sending email statement...
...
do_email_reader = true;
	...
	//if disabled... enter your desired string here...
	var emailReader = "\1nrÞÞÝh±Þnþ rhkeadingn y<<hw@SMB_CURMSG@\1yof\1n\1h\1w@SMB_MSGS@y>>kw ::y <n?-hhkelpny>hk y;n";
...
do_file_lister = true;
	...
	//create a list of lightbar options w/ strings...		
	string.optionOne	= "n\r6°±²Û Û0Þ cNwexthb kprev flag view skip quit nÞhkþn nk6 @LIB@ nk6+ nk6@DIR@nk6>n";
	string.optionTwo	= "n\r6°±²Û Û0Þ hknext ncPwrevhk flag view skip quit nÞhkþn nk6 goto nk6previous nk6displaynk6>n";
	string.optionThree	= "n\r6°±²Û Û0Þ hknext prev ncFwlaghk view skip quit nÞhkþn nk6 flag nk6files nk6for nk6download nk6laternk6>n";
	string.optionFour	= "n\r6°±²Û Û0Þ hknext prev flag ncVwiewhk skip quit nÞhkþn nk6 view nk6contents nk6of nk6a nk6filenk6>n";
	string.optionFive	= "n\r6°±²Û Û0Þ hknext prev flag view ncSwkiphk quit nÞhkþn nk6 skip nk6ahead nk6to nk6next nk6directorynk6>n";
	string.optionSix	= "n\r6°±²Û Û0Þ hknext prev flag view skip ncQwuithk nÞhkþn nk6 quit nk6back nk6to nk6file nk6menunk6>n";
	...
	//if disabled... enter your desired string here...
	var fileLister = "n\r6°±²Û Û0Þ hknext prev flag view skip quit nÞhkþn nk6 @LIB@ nk6+ nk6@DIR@nk6>n";
