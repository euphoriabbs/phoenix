...
//commands available for the menu...
	switch(cmdkey=console.getkeys("ABCDEFGHIJKLMNOPQRSTUVWXYZ?@;Q#$%-",K_UPPER)) {
        ...
        case 'I': // Index Listing (kinda like Mystic)
            bbs.exec("?/euphoria/phoenix/mods/DDMsgAreaChooser.js");
            bbs.exec("?/euphoria/phoenix/mods/DDMsgReader.js");
            break;
...
//if disabled...
	...
	switch(cmdkey=console.getkeys("ABCDEFGHIJKLMNOPQRSTUVWXYZ?;@#$%-",K_UPPER)) {
        ...
        // File Lister (indexed)
        case 'I': // Index Listing (kinda like Mystic)
			// load("/euphoria/phoenix/mods/DDFileAreaChooser.js");
			bbs.exec("?/euphoria/phoenix/mods/filearea-lb.js");
            break;
