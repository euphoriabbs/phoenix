...
bbs.replace_text(661,"@NOPAUSE@@CLS@@TYPE:/euphoria/phoenix/artwork/art.phoenix.file_lister.ans@@NOPAUSE@");
...
var strHeaderFile = "/euphoria/phoenix/artwork/art.phoenix.menu_oneliner.ans"; //ansi header...
...
bbs.menu.ansi_gallery = function() {
	...
	var string = directory('/euphoria/phoenix/artwork/gallery/*.ans');
...
console.putmsg("@TYPE:/euphoria/phoenix/artwork/" + fname + ".ans@");
...
bbs.mods.vanguard.ansislow = function(fname) {
	file_base = "/euphoria/phoenix/artwork/" + fname;
	if (file_exists(file_base))
		f = new File(file_base);
		...
		console.print("file doesn't exist: /euphoria/phoenix/artwork/" + fname + ".???\r\n");
		return;
	}
	if(!f.open("r")) {
		console.print("error opening file: " + f.name + "\r\n");
