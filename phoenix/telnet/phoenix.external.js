...
if(do_message_reader && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_P))) {
	bbs.replace_text(71,"@EXEC:/euphoria/phoenix/telnet/phoenix.message_reader.js@");
...
bbs.replace_text(9,"@NOPAUSE@@CLS@@TYPE:/euphoria/phoenix/artwork/art.phoenix.message_reader.ans@@NOPAUSE@");
...
if(do_email_reader && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_P))) {
	bbs.replace_text(49,"@EXEC:/euphoria/phoenix/telnet/phoenix.email_reader.js@");
...
if(do_file_lister && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_Q))) {
	bbs.replace_text(660,"@EXEC:/euphoria/phoenix/telnet/phoenix.file_lister.js@");
...
bbs.replace_text(661,"@NOPAUSE@@CLS@@TYPE:/euphoria/phoenix/artwork/art.phoenix.file_lister.ans@@NOPAUSE@"); //the header ansi...
...
if(do_yesno_lightbar && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_R))) {
	bbs.replace_text(559,"@NOPAUSE@@EXEC:/euphoria/phoenix/telnet/phoenix.yesnobar.js@@NOPAUSE@");	//defaults on yes...
	bbs.replace_text(562,"@NOPAUSE@@EXEC:/euphoria/phoenix/telnet/phoenix.noyesbar.js@@NOPAUSE@");	//defaults on no...

//if disabled...
}else{
	bbs.replace_text(559,"@NOPAUSE@@EXEC:/euphoria/phoenix/telnet/phoenix.yesno.js@@NOPAUSE@"); //defaults on yes...
	bbs.replace_text(562,"@NOPAUSE@@EXEC:/euphoria/phoenix/telnet/phoenix.noyes.js@@NOPAUSE@"); //defaults on no...
}
...
if(do_animated_pause && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_O))) {
	bbs.replace_text(563,"@EXEC:/euphoria/phoenix/telnet/phoenix.anipause.js@");
