...
if(do_message_reader && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_P))) {
	bbs.replace_text(71,"@EXEC:../../layouts/phoenix_s3/telnet/phoenix.message_reader.js@"); 
...
bbs.replace_text(9,"@NOPAUSE@@CLS@@TYPE:../../layouts/phoenix_s3/artwork/art.phoenix.message_reader.ans@@NOPAUSE@");
...
if(do_email_reader && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_P))) {
	bbs.replace_text(49,"@EXEC:../../layouts/phoenix_s3/telnet/phoenix.email_reader.js@"); 
...
if(do_file_lister && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&U1FLAG_Q))) {
	bbs.replace_text(660,"@EXEC:../../layouts/phoenix_s3/telnet/phoenix.file_lister.js@");
...
bbs.replace_text(661,"@NOPAUSE@@CLS@@TYPE:../../layouts/phoenix_s3/artwork/art.phoenix.file_lister.ans@@NOPAUSE@"); //the header ansi...
...
if(do_yesno_lightbar && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_R))) {
	bbs.replace_text(559,"@NOPAUSE@@EXEC:../../layouts/phoenix_s3/telnet/phoenix.yesnobar.js@@NOPAUSE@");	//defaults on yes...
	bbs.replace_text(562,"@NOPAUSE@@EXEC:../../layouts/phoenix_s3/telnet/phoenix.noyesbar.js@@NOPAUSE@");	//defaults on no... 

//if disabled...
}else{
	bbs.replace_text(559,"@NOPAUSE@@EXEC:../../layouts/phoenix_s3/telnet/phoenix.yesno.js@@NOPAUSE@"); //defaults on yes...
	bbs.replace_text(562,"@NOPAUSE@@EXEC:../../layouts/phoenix_s3/telnet/phoenix.noyes.js@@NOPAUSE@"); //defaults on no... 
}
...
if(do_animated_pause && (!(bbs.sys_status&SS_USERON) || (user.security.exemptions&UFLAG_O))) {
	bbs.replace_text(563,"@EXEC:../../layouts/phoenix_s3/telnet/phoenix.anipause.js@");
